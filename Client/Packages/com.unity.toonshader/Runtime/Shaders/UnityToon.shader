...
//ToonCoreStart
        Pass {
            ...
            // Foveated rendering 지원 조건은 URP 코어의 정식 헤더에 위임한다.
            // (직접 박은 UNITY_PLATFORM_OSX/IOS 조건은 URP 17.4의 visionOS 한정 구현과 어긋나
            //  Metal에서 RemapFoveatedRenderingLinearToNonUniform undeclared 에러를 유발했음)
