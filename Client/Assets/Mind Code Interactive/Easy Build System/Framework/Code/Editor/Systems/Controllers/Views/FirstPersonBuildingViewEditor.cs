...
/// Class : FirstPersonBuildingViewEditor.cs
...
namespace MindCodeInteractive.EasyBuildSystem.Framework.Code.Editor.Systems.Controllers.Views
{
    [CustomEditor(typeof(FirstPersonBuildingView), true)]
    public class FirstPersonBuildingViewEditor : BuildingViewEditor
    {
        protected override void OnInspectorDraw()
        {
            base.OnInspectorDraw();

            EditorGUIExtended.Separator("First Person Settings", true);
            Properties.Draw("m_originTransform", new GUIContent("Origin Transform", "Transform used as the camera origin for first person view."));
        }
    }
}