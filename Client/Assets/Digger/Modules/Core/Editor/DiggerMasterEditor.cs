...
namespace Digger.Modules.Core.Editor
{
    ...
    public class DiggerMasterEditor : UnityEditor.Editor
    {
        ...
        public void OnInspectorGUILightingTab()
        {
            ...
            var isRuntime = FindAnyObjectByType<ADiggerRuntimeMonoBehaviour>() != null;
            if (isRuntime) {
        ...
        public void OnInspectorGUISettingsTab()
        {
            ...
            EditorGUILayout.BeginVertical(EditorStyles.helpBox);
            {
                ...
                if (master.CreateLODs) {
                    if (FindAnyObjectByType<ADiggerRuntimeMonoBehaviour>()) {
                        EditorGUILayout.HelpBox(
        ...
        {
            if (!FindAnyObjectByType<DiggerMaster>()) {
            ...
            try {
                ...
                foreach (var terrain in terrains) {
                    ...
                    if (existingDiggers.Count(system => system.Terrain == terrain) ==
                        0) {
            ...
            foreach (var digger in diggers) {
                ...
                if (ver != DiggerSystem.DiggerVersion) {
                    ...
                    if (ver < 40 || ver >= 10000 && ver < 10040) {
                        var diggerMaster = FindAnyObjectByType<DiggerMaster>();
                        if (diggerMaster) {
